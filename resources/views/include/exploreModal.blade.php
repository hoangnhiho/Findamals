	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img class="" src="http://orig02.deviantart.net/6e18/f/2010/255/3/b/battle_on_mt__silver_by_serain-d2yjudv.jpg" alt="Findamals Koala Character" style="width:100%">
				<p>Fight me!! if you dare Mwahaha!!!</p>
			</div>
			<div class="modal-footer">
				<button id="acceptBtn" type="button" class="btn btn-danger" data-dismiss="modal" data-toggle="modal" href="">Fight</button>
...
<div id="incorrectAns" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Return to game</button>
			</div>
		</div>
	</div>
</div>
